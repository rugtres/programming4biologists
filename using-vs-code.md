...
4. At the bottom of VSC, there are three buttons: Build ![gear](img/gear_icon.png), Debug ![bug](img/debug_icon.png) and Run ![launch](img/launch.png). Press the play icon ![launch](img/launch.png) to execute your code, and it will display `Hello CMake` in the terminal panel. 
